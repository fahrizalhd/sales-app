                ...
                <form method="POST" action="{{ route('sales.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="overflow-hidden border rounded-md shadow-sm border-gray-300">
                                <table class="text-sm text-center text-gray-500">
                                    ...
                                    <tbody id="items-table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-2 py-2">
                                                <button type="button" class="remove-row text-red-600 flex items-center">
