            ...
            <div class="flex justify-between mb-4">
                <div class="inline-flex justify-start gap-4">
                    ...
                    <div class="flex items-center justify-start gap-2">
                        ...
                        <div
                            x-data="{
                                lowStock: {{ request("filter.low_stock", 0) ? "true" : "false" }},
                            }">
                            <button
                                @click="
                        lowStock = !lowStock;
                        ...
                        "
                                ...
                                class="px-3 py-2 rounded-full text-xs flex items-center justify center whitespace-nowrap"
                                type="button">
                                Low Stock
                            </button>
                        </div>
                        ...
                        <div
                            x-data="{
                                isInactive: {{ request("filter.is_active", 1) == 0 ? "true" : "false" }},
                            }">
                            <button
                                @click="
                ...
                <table class="w-full text-sm text-center rtl:text-right text-gray-500">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">
                                <x-sort-link column="category" label="Category"></x-sort-link>
                            </th>
                            <th scope="col" class="px-6 py-3">
                                <x-sort-link column="price" label="Price"></x-sort-link>
                            </th>
                            <th scope="col" class="px-6 py-3">
                                <x-sort-link column="quantity" label="Stock"></x-sort-link>
                            </th>
                            <th scope="col" class="px-6 py-3">
                                <x-sort-link column="is_active" label="Status"></x-sort-link>
                            </th>
