                ...
                <div class="flex items-center">
                    ...
                    <div x-data="{lowStock: {{ request()->has('low_stock') ? 'true' : 'false' }} }">
                        ...
                        "
                            ...
                            class="px-5 py-2.5 rounded-full text-xs flex items-center justify center whitespace-nowrap ml-2" type="button">
                            Low Stock
                        </button>
                    </div>
                </div>

                <a href="{{ route('items.create') }}" class="flex items-center gap-1 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5">
                        ...
                        <tr data-href="{{ route('items.edit', $item) }}" class="bg-white border-b border-gray-200 hover:bg-gray-50 cursor-pointer">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @elseif ($item->quantity <= 10 && $item->quantity > 0)
                                    <span
                                        data-tooltip-target="tooltip-{{ $item->id }}-click"
                                        ...
                                        <span class="text-xs ml-1 hidden sm:inline">Low Stock</span>
                                    </span>
                                    ...
                                    <span class="bg-red-200 text-red-600 inline-flex items-center rounded-sm px-2 py-1 ml-2">
                                        ...
                                        <span class="text-xs ml-1 hidden sm:inline">Out of Stock</span>
                                    </span>
                                    @endif
                            </td>
                            <td class="px-6 py-4">
