<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-gray-800">Payment - {{ $sale->invoice_number }}</h2>
    </x-slot>
    ...
    <div class="max-w-xl mx-auto mt-6 bg-white p-6 rounded shadow">
        <form method="POST" action="{{ route('payments.store') }}">
            ...
            <div class="mb-4">
                <label class="block font-medium">Total Bill</label>
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded">Pay</button>
            </div>
        </form>
    </div>
</x-app-layout>
