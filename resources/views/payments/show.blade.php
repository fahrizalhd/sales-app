                    ...
                    <div class="flex justify-between gap-2 mt-4">
                        <div class="flex justify-start gap-2">
                            ...
                            <form action="{{ route('payments.approve', $payment->id) }}" method="POST" onsubmit="return confirm('Approve this payment?')">
                                ...
                                @method('PATCH')
                                <button type="submit"
                                    class="flex items-center gap-2 text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none">
                        ...
                        <div class="flex justify-end gap-2">
                            ...
                            <a href="{{ route('payments.print', $payment) }}" target="_blank"
                                class="flex items-center gap-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5">
                                <svg class="w-[20px] h-[20px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
